...
DL_DIR="/home/ricardo/projects/rica_s/"
...
wget -r -np -nH --cut-dirs=1 -P $DL_DIR/ ftp://donut.cs.bilkent.edu.tr/rica_s/tools/rica_s_pr_abricate/
...
# echo "=== downloading cu-clark db"
# wget -r -np -nH --cut-dirs=1 -P $DL_DIR/ ftp://donut.cs.bilkent.edu.tr/rica_s/tools/rica_s_id_metabuli/
